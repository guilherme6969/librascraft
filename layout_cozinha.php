<?php
include("menu.php");
$img_palavra = "armario.png";
$palavra = "armario";
?>
<style>
	body 
	{
		background: url("img/casa/comodo/cozinha.png") no-repeat center top fixed;
		width:100%; 
        overflow: hidden;
	}
</style>
						...
						<div class="row">
							...
							<div class="row mt-4 mx-md-n5">
								<div class="col py-3 px-md-3 border bg-light d-flex flex-column justify-content-center align-items-center">
									<img src="img/casa/cozinha/objetos/<?php echo $img_palavra;?>" class="rounded float-left" style="width:70%; margin-top:-40px;">
								</div>
								<!-- VIDEO EM LIBRAS -->
