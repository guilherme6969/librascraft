            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-9 mx-auto" style="margin-top:-150px;">
                    <div class="card card-signin my-5" style="border-color:#828282;">
                        ...
                        <button class="btn btn-lg btn-google btn-block w-50 text-uppercase" id="btn-modal-finalizar" style="border-color:darkgreen;background-color:green;color:white; margin-left:200px; margin-top:-80px; display:none;" data-toggle="modal" data-target="#modal-mensagem">FINALIZAR</button> <!-- BOTAO MODAL FINALIZAR -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="card-body">
                                            ...
                                            <br />
                                            <button class="btn btn-lg btn-google btn-block text-uppercase" style="border-color:#828282;background-color:#828282;color:white; display:none;" type="submit" onclick = "location.href='atividade_<?php echo $_SESSION['condicao_auditiva'];?>.php?pagina=8'"><i class="fab fa-google mr-2"></i> Sim, vamos lá!</button>
                                            <button class="btn btn-lg btn-google btn-block text-uppercase" style="border-color:#828282;background-color:#828282;color:white; display:none;--" type="submit" onclick = "location.href='mapa.php'"><i class="fab fa-google mr-2"></i> Não, voltar para o mapa!</button>
                                        </div>
